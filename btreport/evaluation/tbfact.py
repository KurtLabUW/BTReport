...
--- Modified by Juampablo Heras Rivera ---
Excerpted from: https://github.com/microsoft/healthcare-ai-model-evaluator/tree/main/functions/medbench/evaluators/tbfact
Adapted for usage with open-source models through Ollama HuggingFace etc.
